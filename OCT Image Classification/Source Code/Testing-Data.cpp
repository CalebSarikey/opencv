...
// Testing-Data.cpp - Computes and writes testing data to text files
...
int main() {
	...
	// Testing data 45 normal images: {N1, N5, N9, N13, ..., N177}
	// and 26 AMD images: {A1, A5, A9, A13, ..., A101}
	int N;
	for (int k = 0; k <= 1; k++) {
		if (k == 0)
			N = 180;
		...
		for (int i = 1; i <= N; i += 4)
		{
			...
			outfiles[0] = "C:\\Users\\csari\\Desktop\\A4\\A4\\x64\\Debug\\Normal-Testing.txt";
			outfiles[1] = "C:\\Users\\csari\\Desktop\\A4\\A4\\x64\\Debug\\AMD-Testing.txt";
			ofstream outFile;
